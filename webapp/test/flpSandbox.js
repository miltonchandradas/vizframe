		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "VizFrame charts and its features",
									"targetURL": "#comsapvizframe-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapvizframe-display": {
								"semanticObject": "comsapvizframe",
								"action": "display",
								"description": "VizFrame charts and its features",
								"title": "VizFrame charts and its features",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.vizframe",
									"url": sap.ui.require.toUrl("com/sap/vizframe")
								}
							}
						}
					}
